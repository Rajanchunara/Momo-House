    ...
    <div>
      ...
      <div className="h-[650px]">
        ...
        <div className="ml-[110px] text-white pt-[350px]">
          ...
          <NavLink
            to="https://www.youtube.com/watch?v=UJPSLxV0cLk"
            target="_blank"
          >
      ...
      <div className="ml-[110px] flex gap-[120px] h-[500px] mt-[80px]">
        <div className="w-[456px] h-[270px]">
          ...
          <div className="flex items-center justify-center mt-[30px] gap-6 w-[456px] h-[152px] shadow-2xl rounded-2xl">
            <h1 className="flex flex-col text-[25px] text-teal-600">
              Scan the QR code{" "}
        ...
        <div>
          <img
            src={services3}
            alt=""
            className="w-[500px] h-[450px] absolute right-[100px] rounded-[16px]"
          />
        </div>
      </div>
      ...
      <div className="ml-[110px] gap-[120px] h-[500px] flex mt-[60px]">
        <div>
          <img
            src={services3}
            alt=""
            className="w-[500px] h-[450px] mt-[10px] rounded-[16px]"
          />
        </div>
      ...
      <div className="h-[300px] w-[1070px] bg-gray-100 flex flex-col justify-center items-center mt-[20px] ml-[110px] rounded-[24px]">
        ...
        <NavLink to="/contactus">
          <button className="h-[60px] w-[220px] rounded-[100px] bg-teal-700 text-white text-[16px] mt-[40px] hover:bg-teal-900">
            Get In Touch
          </button>
        </NavLink>
      </div>

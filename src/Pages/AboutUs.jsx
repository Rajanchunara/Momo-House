    ...
    <div>
        ...
        <div className="mt-[100px]">
          ...
          <p className="flex flex-col text-orange-600 font-bold text-[25px] mt-[10px]">
            ...
            <span className="text-black">
              passed down through{" "}
              <span className=" flex flex-col">generations</span>
            </span>
          </p>
        </div>
      ...
      <div className="h-[650px]">
        <img
          src={about1}
          alt=""
          className="h-[640px] absolute -z-50 brightness-35 blur-[1px]"
        />
        <div className="ml-[110px] text-white pt-[350px]">
          ...
          <NavLink
            to="https://www.youtube.com/watch?v=uJlIncioJVI"
            target="_blank"
          >
            <button className="flex justify-center items-center gap-4 w-[231px] h-[64px] bg-teal-600 rounded-[100px] text-[16px] mt-[50px] hover:bg-teal-800">
              <FaPlayCircle className="h-[32px] w-[32px]" /> Watch the Video
            </button>
          </NavLink>
        </div>
      </div>
        ...
        <div className="ml-[110px] flex gap-[120px] h-[500px]">
          ...
          <div className="flex">
            <img
              src={image}
              alt=""
              className="w-[264px] h-[191px] absolute right-[420px] mt-[250px] z-10 "
            />
            <img
              src={image1}
              alt=""
              className="w-[450px] h-[350px] absolute right-[100px]"
            />
          </div>
        </div>
        ...
        <div className="ml-[110px] gap-[120px] h-[500px] flex mt-[60px]">
          <div className="flex">
            <img
              src={image3}
              alt=""
              className="w-[264px] h-[191px] mt-[250px] absolute left-[400px] z-10 "
            />
            <img
              src={image2}
              alt=""
              className="w-[450px] h-[350px] mt-[10px]"
            />
          </div>
      ...
      <div className="h-[600px]">
        <img
          src={image7}
          alt=""
          className="h-[500px] w-full absolute -z-50 blur-[3px] brightness-35"
        />
        <div className="absolute text-white w-[550px] ml-[110px] mt-[150px] space-y-8">
          ...
          <h1 className="flex flex-col font-bold text-[20px]">
            Marcus Schleifer <span>CEO</span>
          </h1>
          <div className="text-[40px] space-x-4 flex justify-end ">
            <button>
              <FiArrowLeftCircle className="text-gray-500" />
            </button>
            <button>
              <FiArrowRightCircle className="text-gray-500" />
            </button>
          </div>
        </div>
      ...
      <div>
        <div className="flex flex-col items-center">
          ...
          <p className="text-[25px] text-teal-600">
            ...
            return (
              <div key={data.id}>
                <img
                  src={data.image}
                  alt=""
                  className="h-[450px] w-[300px] rounded-[4px] absolute -z-50 brightness-50"
                />
                <h1 className="pt-[400px] ml-[20px] text-[20px] font-bold text-white">
                  {data.name}
                </h1>
              </div>
            );
